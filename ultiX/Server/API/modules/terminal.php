                     ...
                     <div class="card">
                        <div class="card-body">
                           ...
                           <div class="list-group">
                            ...
                            <?php echo '<a href="#" class="list-group-item list-group-item-action px-3 border-0 ripple active"> <i class="bi bi-terminal"></i> Terminal</a>'?>
                  ...
                  <div class="col">
                     <div class="row">
                        <div class="col">
                           <div class="card">
                              <div class="card-body">
                                 <h2><i class="bi bi-terminal"></i> Terminal</h2>
                                 <hr class="my-2">
                                 <h6>Command: </h6>
                                 <div class="form-group-sm">
                                    <input class="form-control form-control-sm" type="text" placeholder="whoami" id="terminalCapture">
                                 </div>
                                 <hr class="my-2">
                                 <div id="alerts"> </div>
                                 <button onclick="sendTerminalCommand()" type="button" class="btn btn-primary"> Send Command  <i class="bi bi-arrow-up-right-circle-fill"></i> </button>
                              </div>
                           </div>
                           <div class="col">
                              <div class="card">
                                 <div class="card-body">
                                    <h2> <i class="bi bi-terminal"></i> Terminal Output</h2>
                                    <hr class="my-2">
                                    <div class="terminal">
                                       <!-- <h4> Commands here </h4> -->
                                       <!-- <p> realdutch\gebruiker </p> -->
                                       <?php
                                       $Agent_Terminal_Json_File = "../../ultiX-Data/" . $agent_UID . "/terminal.json";
                                       $agent_data = file_get_contents($Agent_Terminal_Json_File);
                                       $data = json_decode($agent_data, true);
                                       foreach ($data["commands"]as $field => $value) {
                                          echo '<h3>' . $value["commandTitle"] . '</h3>';
                                          echo '<p>' . $value["command"] . '</p>';
...
function sendTerminalCommand() {
   ...
   const TerminalCommand = document.getElementById("terminalCapture").value;
