            ...
            <div class="col-md-12 mb-3">
              <div class="row">
                  <div class="col-sm-4">
                     <div class="card">
                        <div class="card-body">
                           ...
                           <?php echo '<a href="#" class="list-group-item list-group-item-action px-3 border-0 ripple active"> <i class="bi bi-plug"></i> Shutdown / Reboot</a>'?>
                  ...
                  <div class="col">
                     <div class="card">
                        <div class="card-body">
                           <h2> <i class="bi bi-plug"></i> Shutdown / Reboot</h2>
                           <hr class="my-2">
                           <h6>Select Option: </h6>
                           <select class="form-select form-select-sm" aria-label=".form-select-sm example" id="option">
                              <option value="Shutdown">Shutdown</option>
                              <option value="Reboot">Reboot</option>
                           </select>
                           <hr class="my-2">
                           <div id="alerts"> </div>
                           <button onclick="sendOptions()" type="button" class="btn btn-primary"> Send Command <i class="bi bi-arrow-up-right-circle-fill"></i> </button>
                        </div>
                     </div>
                  </div>
              </div>
