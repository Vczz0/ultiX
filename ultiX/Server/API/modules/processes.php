                  ...
                  <div class="col-sm-4">
                     <div class="card">
                        <div class="card-body">
                           ...
                           <div class="list-group">
                              ...
                              <?php echo '<a href="#" class="list-group-item list-group-item-action px-3 border-0 ripple active"> <i class="bi bi-cpu"></i> Active Processes</a>'?>
                   ...
                   <div class="col">
                        <div class="col">
                           <div class="card">
                                 <div class="card-body">
                                    <h2> <i class="bi bi-cpu"></i> Active Processes</h2>
                                    <hr class="my-2">
                                    <div id="alerts"> </div>
                                    <button type="button" onclick="sendProc()" class="btn btn-primary"> Send Command  <i class="bi bi-arrow-up-right-circle-fill"></i> </button>        
                                </div>
                            </div>
                        </div>
                        <div class="col">
                           <div class="card">
                              <div class="card-body"> 
                                 <h2> <i class="bi bi-cpu"></i> Process Details</h2>
                                 <hr class="my-2">
                                 <table class="table data-table table-bordered table-hover" id="">
                                    ...
                                    <tbody> 
                                       <?php
                                       $uid_proc_folder = "../../ultiX-Data/".$agent_UID."/proc.json";
                                       $proc_data = file_get_contents($uid_proc_folder);
                                       $data1 = json_decode($proc_data, true);
                                       $data = $data1["proc"]["proc"];
                                       $str_arr = explode("NewProc", $data);
                                       $total_processes = 1;
                                       foreach ($str_arr as $proc) {
                                          $pid = substr($proc, 0, strpos($proc, ","));
                                          $procName = explode(",", $proc, 2)[1];
