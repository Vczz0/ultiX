               ...
               <div class="row">
                     ...
                     <div class="card">
                        <div class="card-body">
                           ...
                           <div class="list-group">
                              ...
                              <?php echo '<a href="#" class="list-group-item list-group-item-action px-3 border-0 ripple active"> <i class="bi bi-clipboard"></i> Clipboard</a>'?>
                  ...
                  <div class="col">
                        <div class="col">
                           <div class="card">
                                <div class="card-body">
                                    <h2> <i class="bi bi-clipboard"></i> Retrieve clipboard</h2>
                                    <hr class="my-2">
                                    <div id="alerts"> </div>
                                    <button onclick="sendClip()" type="button" class="btn btn-primary"> Send Clipboard Command <i class="bi bi-arrow-up-right-circle-fill"></i> </button>
                              </div>
                           </div>
                        </div>
                        <div class="col">
                           <div class="card">
                                <div class="card-body">
                                    <h2> <i class="bi bi-clipboard"></i> Clipboard Log</h2>
                                    <hr class="my-2">
                                    <table class="table data-table table-files table-bordered table-hover" id=""> 
                                        <thead> 
                                            <tr> 
                                                <th scope="col">Time</th>
                                                <th scope="col">ClipData</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        <?php
                                        $clipboard_data = "../../ultiX-Data/" . $agent_UID . "/clipboard.json";
                                        $clip_data = file_get_contents($clipboard_data);
                                        $data = json_decode($clip_data, true);
                                        foreach ($data["clip"]as $field => $value) {
                                            echo "<tr>";
                                            echo '<td>'.$value["date"].'</td>';
                                            echo '<td>'.$value["clipDat"].'</td>';
                                            echo "</tr>";
                                        }
                                        ?>
                                        </tbody>
