                  ...
                  <div class="col-sm-4">
                     <div class="card">
                        <div class="card-body">
                           ...
                           <div class="list-group">
                              ...
                              <?php echo '<a href="#" class="list-group-item list-group-item-action px-3 border-0 ripple active"> <i class="bi bi-window"></i> Window Text</a>'?>
                   ...
                   <div class="col">
                        <div class="col">
                           <div class="card">
                                 <div class="card-body">
                                    <h2> <i class="bi bi-window"></i> Window Text</h2>
                                    <hr class="my-2">
                                    <div id="alerts"> </div>
                                    <button type="button" onclick="sendWindow()" class="btn btn-primary"> Send Command <i class="bi bi-arrow-up-right-circle-fill"></i> </button>        
                                </div>
                            </div>
                        </div>
                        <div class="col">
                           <div class="card">
                              <div class="card-body"> 
                                 <h2> <i class="bi bi-window"></i> Window Text Log</h2>
                                 <hr class="my-2">
                                 <table class="table data-table table-bordered table-hover" id="">
                                    ...
                                    <tbody> 
                                       <?php
                                        $window_data = "../../ultiX-Data/" . $agent_UID . "/window.json";
                                        $win_data = file_get_contents($window_data);
                                        $data = json_decode($win_data, true);
                                        foreach ($data["window"]as $field => $value) {
                                            echo "<tr>";
                                            echo '<td>'.$value["CurrentDate"].'</td>';
                                            echo '<td>'.$value["window"].'</td>';
                                            echo "</tr>";
                                        }
                                          ?>
                                    </tbody>
