               ...
               <div class="row">
                     ...
                     <div class="card">
                        <div class="card-body">
                           ...
                           <div class="list-group">
                              ...
                              <?php echo '<a href="messagebox.php?uid='.$agent_UID.'"'.'class="list-group-item list-group-item-action px-3 border-0 ripple active"> <i class="bi bi-chat-left-dots"></i> Messagebox</a>'?>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="col">
                        <div class="col">
                           <div class="card">
                                <div class="card-body">
                                    <h2> <i class="bi bi-chat-left-dots"></i> Messagebox</h2>
                                    <hr class="my-2">
                                    <div id="alerts"> </div>
                                    <button onclick="sendMessage()" type="button" class="btn btn-primary"> Send Command <i class="bi bi-arrow-up-right-circle-fill"></i> </button>
                              </div>
                           </div>
                        </div>
                        <div class="col">
                           <div class="card">
                                <div class="card-body">
                                    <h2> <i class="bi bi-chat-left-dots"></i> Messagebox - Settings</h2>
                                    <hr class="my-2">
                                    <h6>Select Messagebox:</h6>

                                    <select class="form-select form-select-sm" aria-label="Default select example" id="messageBoxExample">
                                        <option value="MessageBoxInfo">Info Messagebox</option>
                                        <option value="MessageBoxWarning">Warning Messagebox</option>
                                        <option value="MessageBoxError">Error Messagebox</option>
                                    </select>

                                    <hr class="my-2">
                                    <h6>Messagebox Title</h6>
                                    <input type="text" class="form-control form-control-sm" placeholder="Title" aria-label="Title" id="Title">

                                    <hr class="my-2">
                                    <h6>Messagebox Message</h6>
                                    <input type="text" class="form-control form-control-sm" placeholder="Message" aria-label="Message" id="Message">
                              </div>
                           </div>
                        </div>
...
function sendMessage() {
    ...
    var messageType = document.getElementById("messageBoxExample").value;
