                     ...
                     <div class="card">
                        <div class="card-body">
                           ...
                           <div class="list-group">
                              ...
                              <?php echo '<a href="#" class="list-group-item list-group-item-action px-3 border-0 ripple active"> <i class="bi bi-image"></i> ScreenCapture</a>'?>
                  ...
                  <div class="col">
                     <div class="row">
                        <div class="col">
                           <div class="card">
                              <div class="card-body">
                                 <h2> <i class="bi bi-image"></i> ScreenCapture</h2>
                                 <hr class="my-2">
                                 <div id="alerts"> </div>
                                 <button onclick="sendScreenshot()" type="button" class="btn btn-primary"> Send Command  <i class="bi bi-arrow-up-right-circle-fill"></i> </button>
                           ...
                           <div class="col">
                              <div class="screencapture-history">
                                 <div class="card">
                                    <div class="card-body">
                                       <h2> <i class="bi bi-clock-history"></i> ScreenCapture - History</h2>
                                       <hr class="my-2">
                                       <table class="table data-table table-bordered table-hover" id="">
                                          ...
                                          <tbody>
                                             <?php
                                             $uid_screenshot_folder = "../../ultiX-Data/".$agent_UID."/screenshots";
                                             $screens = glob($uid_screenshot_folder."/*.png");
                                             
                                             foreach($screens as $screenshot) {
                                                $screenshotName = explode('screenshots/', $screenshot);
                                                $fileName = explode('RandomStr', $screenshot);
                                                $firstDateScreenshot = str_replace(".png", "", $screenshotName[1]);
                                                $datetime = substr($firstDateScreenshot, 0, strpos($firstDateScreenshot, "RandomStr"));
                                                echo "<tr>";
                                                echo '<td>'.$datetime.'</td>';
                                                echo '<td>'.'<a href="'.$screenshot.'"'.'>'.$fileName[1].'</a>'.'</td>';
                                                echo "</tr>";
                                             }
                                          ?>
                                          </tbody>
